...
public class Student {
    ...
    public List<User> getBookList2() {
        return bookList2;
    }

    public void setBookList2(List<User> bookList2) {
    ...
    public Student(String[] books, Set<String> bookSet, List<String> bookList, Map<String, String> bookMap, List<User> bookList2) {
        this.books = books;
        this.bookSet = bookSet;
        this.bookList = bookList;
        this.bookMap = bookMap;
